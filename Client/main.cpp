                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CLIENT)); //-> 단축키 정보
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   g_hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW, //szTitle -> 윈도우 테이블 명
