...
{	
	...
	//((CBtnUI*)pClonePanel->GetChildUI()[0])->SetClickedCallBack(ChangScene, 0, 0);
...
void CScene_Tool::SaveTileData()
{
	...
	wstring strTileFolder =	CPartMgr::GetInst()->GetContentPath();
...
void CScene_Tool::LoadTileData()
{
	...
	{
		wstring strRelativePath = CPartMgr::GetInst()->GetRelativePath(szName);
